        ...
        UpdateGraph(width, height, r, color, force, svg, jsonfile,640,40);
                    ...
                    .on("dragend", function(d) {
                        ...
                        d3.select("#time-scroller")
                           ...
                           d3.select("#time-scroller").attr("x",function(d){
                            ...
                            UpdateGraph(width, height, r, color, force, svg, "../backend/data/" + datetime + "/" + "basic-graph-data.json",d.x,d.y);
