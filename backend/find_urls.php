...
$sql = "SELECT FirstName, LastName ,image FROM vouleutes ";
			...
			foreach ($deputies as $key => $value) {
				...
				echo "<form style='background-color:#799DA2; margin:5px;'action='updatedb.php' method='post'>";
				...
				echo "<input style='width:80%;'></input><button style='width:9%; background-color:black; color:white;' type='submit'>Submit</button></div>";
				echo "</div>";
				echo "</form>";
			}
				echo "</div>";
